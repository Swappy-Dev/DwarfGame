...
public static class ProceduralGenerationAlgorithm
{
    ...
    public static HashSet<Vector2Int> SimpleRandomsWalk(Vector2Int startPosition, int walkLength)
    {
        ...
        while(roomsQueue.Count > 0)
        {
            ...
            if(room.size.y >= minHeight && room.size.x >= minWidth)
            {
                if(UnityEngine.Random.value < 0.5f)
                {
                    ...
                    {
                        SplitHorizontaly(minWidth, roomsQueue, room);
...
public static class Direction2D
{
    ...
    public static List<Vector2Int> DiagonallDirectionsList = new List<Vector2Int>()
    {
